      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 pt-32 pb-20">
          <div className="text-center animate-fade-in">
            ...
            <p className="text-xl text-slate-600 mb-12 max-w-2xl mx-auto leading-relaxed">
              {user?.organization?.name || '您的组织'} 的 {user?.nickname || user?.email || '用户'}
              <br />
              开始管理您的敬拜歌单吧！
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
              <Link href="/calendar" className="group">
                <button className="btn-primary flex items-center gap-3 px-8 py-4 text-lg whitespace-nowrap min-w-[140px]"
                       style={{ backgroundColor: '#3b82f6', color: 'white', padding: '1rem 2rem', borderRadius: '0.5rem', fontSize: '1.125rem' }}>
              ...
              <Link href="/create-songlist" className="group">
                <button className="btn-secondary flex items-center gap-3 px-8 py-4 text-lg whitespace-nowrap min-w-[140px]"
                       style={{ border: '2px solid #3b82f6', color: '#3b82f6', padding: '1rem 2rem', borderRadius: '0.5rem', fontSize: '1.125rem', backgroundColor: 'white' }}>
              ...
              <button 
                ...
                className="group flex items-center gap-3 px-8 py-4 text-lg whitespace-nowrap min-w-[140px]"
                style={{ border: '2px solid #ef4444', color: '#ef4444', padding: '1rem 2rem', borderRadius: '0.5rem', fontSize: '1.125rem', backgroundColor: 'white' }}
              >
